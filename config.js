...
module.exports = {// TODO: add description to app.json
	...
	cookieSecret: process.env.cookieSecret, //- Cookie Secret
	website: process.env.website, //- without the / at the end
	...
	nodes: [
		{
			...
			port: Number(process.env.lavalinkPort), // The port that lavalink is listening to. This must be a number!
